...
- Let readers pin a graph neighborhood, copy a canonical focused-graph link, restore the complete focused neighborhood from a URL, lock unrelated nodes against hover and left-click until cleared, and fit or open that neighborhood explicitly.
...
- `site-navigation`: Add Brain-chooser and version-provenance destinations, let note-page Graph navigation return to the retained unpinned graph, and provide a separate explicit focused-neighborhood action.
